import { Camera as CameraIcon, Wifi, WifiOff, Radio, Gauge } from "lucide-react";
...
interface StatCardProps {
  ...
  value: string | number;
  hint?: string;
  icon: "camera" | "online" | "offline" | "stream" | "bandwidth";
  tone?: "default" | "success" | "destructive" | "info" | "warning";
}

const icons = {
  camera: CameraIcon, online: Wifi, offline: WifiOff, stream: Radio, bandwidth: Gauge,
};
